...
public class WebViewManager extends SimpleViewManager<WebView> {
    private static HashMap<Integer, ReactWebView> sWebViewMap = new HashMap<Integer, ReactWebView>();

    public static void callJavaScript(final String webViewID, final String script)
    {
        final ReactWebView webView = sWebViewMap.get(Integer.parseInt(webViewID));
        if(webView != null)
        {
            new android.os.Handler(Looper.getMainLooper()).post(new Runnable()
            {
                @Override
                public void run() {
                    webView.setInjectedJavaScript(script);
    ...
    protected static final String REACT_CLASS = "XLNReactWebView";
    ...
    protected static class ReactWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.startsWith("http://") || url.startsWith("https://") ||
                ...
                xln.react.Jni.OnWebViewLoadUrl(Integer.toString(view.hashCode()), url);
                return true;
            }
        }
    ...
    protected WebView createViewInstance(ThemedReactContext reactContext) {
        ...
        sWebViewMap.put(webView.hashCode(), webView);
    ...
    public void onDropViewInstance(WebView webView) {
        ...
        sWebViewMap.remove(webView.hashCode());
